package com.project.myproject.ui.fragments.register
...
import com.project.myproject.ui.fragments.register.viewmodel.RegisterViewModel
...
class RegisterFragment :
    ...
    private fun observeRegisterState() {
        viewLifecycleOwner.lifecycleScope.launch {
            sharedViewModel.registrationState.collect { state ->
                when (state) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.registrationState.collect { state ->
                sharedViewModel.setRegistrationState(state)
            }
        }
    }
