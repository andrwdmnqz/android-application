package com.project.myproject.ui.fragments.contacts
...
import com.project.myproject.ui.fragments.contacts.viewmodel.ContactsViewModel
...
import com.project.myproject.ui.fragments.viewpager.ViewPagerFragmentDirections
...
class ContactsFragment : BaseFragment<FragmentContactsBinding>(FragmentContactsBinding::inflate),
    ...
    private fun collectContactsData() {
        viewLifecycleOwner.lifecycleScope.launch {
            sharedViewModel.contacts.collect { contacts ->
    ...
    private fun showSearchNotification(context: Context) {
        val pendingIntent = NavDeepLinkBuilder(context)
            ...
            .setDestination(R.id.searchContacts)
            .createPendingIntent()
